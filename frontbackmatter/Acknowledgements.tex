...
\comment{
    Zum Beispiel (\emph{ironisch} gemeint) könnten Sie den Studienleitenden im Bereich Technik dafür danken, dass Sie diese \LaTeX{}-Vorlage problemfrei für Ihre Ausarbeitung verwenden können.\\
    Oder Professor Hara fürs Erstellen der Vorlage$\ldots$ $\Rightarrow$ \url{https://ko-fi.com/tchara}
}
