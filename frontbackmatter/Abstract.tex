...
\ifthenelse{\boolean{extendedabstract}}{
	{\myName}: \emph{\myTitle\ifdef{\mySubtitle}{\ --\,\mySubtitle}{}}. {\myCompany}. Duale Hochschule Sachsen, {\myAcademy}, {\myStudy}, Bachelor-Arbeit, {\mySubmissionDate}.
...
\comment{Soll oberhalb der Zusammenfassung ein Autorenreferat gesetzt werden, weisen Sie in der Konfiguration in der \texttt{config.tex} im Punkt \emph{2b} der Variable \texttt{extendedabstract} den Wert \texttt{true} zu.}
